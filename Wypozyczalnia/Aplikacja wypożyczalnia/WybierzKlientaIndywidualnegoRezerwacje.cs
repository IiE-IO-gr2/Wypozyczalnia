...
{
    public partial class WybierzKlientaIndywidualnegoRezerwacje : Form
    {
        public WybierzKlientaIndywidualnegoRezerwacje()
        {
            InitializeComponent();
        }
        private void WybierzKlientaIndywidualnegoRezerwacje_Load(object sender, EventArgs e)
        {
        ...
        /// <summary>
        /// Przycisk umożliwiający zatwierdzenie wyboru klienta indywidualnego z bazy
        /// </summary>
